...
import org.ocwiki.controller.rest.util.InvalidParamResult;
...
public abstract class AbstractResource {
	...
	protected <T extends Article> Revision<T> saveNewRevision(
		...
		if (resource.getStatus() == org.ocwiki.data.Status.NEW) {
			resource.setStatus(org.ocwiki.data.Status.NORMAL);
		}
