...
<div>
    <!--  
	 ...
	 -->
	 <button id="articleEdit-save" name="save" type="button" onclick="saveArticle(); return false;">Lưu</button>
	 <button id="articleEdit-back" name="back" type="button" onclick="backArticle(); return false;">Quay lại bài viết</button>
